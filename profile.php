...
while ($row = mysqli_fetch_assoc($query)) {
  ...
  $image = '<img src="http://localhost/borrow/upload/' . basename($row["image"]) . '" width="100" height="100"  role="img"></img>';

  if ($row['image'] == '') {
    $image = '<svg width="100" height="100" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Add Photo" preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="#55595c"></rect><text x="15%" y="50%" fill="#eceeef" dy=".3em">No Image</text></svg>';
  }
            ...
            <div class="row mt-5">
              <div class="col-lg-3">
                  <div class="container">
                    <div class="row">
                      <div>
                        <span class="text-muted"><h4>Your Profile</h4></span>
                      </div>
              ...
              <div class=" col-lg-9 order-md-last">
                ...
                <h4 class="d-flex mb-3">
                  <span class="text-muted ">Device Information</span>
                    ...
                    <div class="col-md-6">
                      <label for="country" class="form-label" style="font-size: 17px;">Borrowed Date</label>
                    ...
                    <div class="col-md-6">
                      <label for="state" class="form-label" style="font-size: 17px;">Returned Date</label>
