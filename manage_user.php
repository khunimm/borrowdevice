...
while ($row = mysqli_fetch_assoc($query)) {
  $update = "
      <a href='user_update_forms.php?id={$row['id']}' class='cancel cancelbtn btn button1' style='color: #C70039;'>
          UPDATE
      </a>
  ";
  ...
  $delete ="
      ...
      <a href = 'user_delete_forms.php?id={$row['id']}' class='cancel cancelbtn btn button1' style='color: #C70039;'>
          DELETE
      </a>
  ";
...
?>
    ...
    <div class="container">
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <div class="row">
              <div class="col-md-1 ">
              <button class=" cancel cancelbtn btn button1" style="color: #C70039;"><a href="user_add_forms.php"> ADD</a></button>
            </div>
