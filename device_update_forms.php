...
<div class="container">
  ...
  <br>
  <form method="post" action="device_update_do.php" enctype="multipart/form-data">
  <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
      ...
      <div class="col-lg-8 center">
        <!-- <form class="needs-validation" novalidate=""> -->
         ...
         <button class="w-100 btn btn-primary btn-lg" type="submit">Continue to update Device</button>
        </form>
      </div>
    </div>
  </main>
