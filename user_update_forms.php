...
<div class="container">
  ...
  <br>
  <form method="post" action="user_update_do.php"  enctype="multipart/form-data" >
  <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
      ...
      <div class="col-lg-8 center">
          ...
          <!-- <button class="button_image button_images">Add Image</button> -->
          ...
          <div class="col-12">
            ...
            <div class="col-12">
              <label for="address2" class="form-label">Role</label>
              <input type="text" class="form-control" name="role" value="<?php echo $row['role']; ?>">
            </div>

            <div class="col-12">
               
              <label for="address2" class="form-label">Status: <?php echo $row['block'] ?></label>
              <!-- <input type="text" class="form-control" name="detail" value="<?php echo $row['detail']; ?>"> -->
              <div class="row">
                <div class="col-md-6">
                  <input type="radio" name="block" value="block" <?php if ($row['block'] == 'block') { echo 'checked'; } ?>> Block
                </div>
                <div class="col-md-6">
                  <input type="radio" name="block" value="unblock" <?php if ($row['block'] == 'unblock') { echo 'checked'; } ?>> Unblock
                </div>
              </div>
            </div>
         ...
         <button class="w-100 btn btn-primary btn-lg" type="submit">Continue to update User</button>
        </form>
      </div>
    </div>
  </main>
