...
<div class="container">
  ...
  <br>
  <form method="post" action="device_delete_do.php" enctype="multipart/form-data">
        ...
        <form class="needs-validation" novalidate="">
          ...
          <hr class="my-4">
            ...
            <div class="row">
                  ...
                  <div class="col-md-6">
                    <!-- <a href="manage_device.php" ><button style="background-color: #C70039;" class="w-100 btn-lg btn"><div style="color: aliceblue;" >Cancle</div></button></a> -->
                    <a href="manage_device.php" style="background-color: #C70039;" class="w-100 btn-lg btn">Cancel</a>
                  </div>
            </div>
        </form>
      </div>
