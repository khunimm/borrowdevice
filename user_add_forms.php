...
<div class="container">
  ...
  <br>
  <form method="post" action="user_add_do.php" enctype="multipart/form-data">
      <div class="row g-5">
        ...
        <form class="needs-validation" novalidate="">
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <input type="text" class="form-control" require="" name="role">
            </div>
  
          <hr class="my-4">

         <button class="w-100 btn btn-primary btn-lg" type="submit">Continue to add User</button>
        </form>
      </div>
    </div>
  </main>
