                ...
                <a class="nav-link active mt-3 notification" aria-current="page" href="circulation_admin.php">
                  <h5>
                    ...
                    <!-- <span class="badge">
                        ...
                        ใส่จำนวนอุปกรที่ถูกยืมแต่ยังไม่ได้ยอมรับ
                    </span> -->
                  </img>
                  </h5>
                </a>
...
<div class="container">
  ...
  <br>
  <form method="post" action="device_add_do.php" enctype="multipart/form-data">
      <div class="row g-5">
      ...
      <div class="col-lg-8 center">
        <form class="needs-validation" novalidate="">
          <div class="row g-3">
            ...
            <div class="col-12">
              <label for="address" class="form-label">Equipment Number</label>
            ...
            <div class="col-12">
              <label for="address" class="form-label">Brand</label>
              <input type="text" class="form-control" required="" name="brand">
            </div>

            <div class="col-12">
              <label for="address" class="form-label">Model</label>
            ...
            <div class="col-12">
              <label for="address2" class="form-label">Detail</label>
              <input type="text" class="form-control" require="" name="detail">
            </div>
  
          <hr class="my-4">

         <button class="w-100 btn btn-primary btn-lg" type="submit">Continue to add Device</button>
        </form>
      </div>
    </div>
  </main>
